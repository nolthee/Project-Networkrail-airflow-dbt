...
PROJECT_ID = "deb2-test-at-home"
GCS_BUCKET = "deb2-end-to-end-project"
BIGQUERY_DATASET = "networkrail"
KEYFILE_FOR_GCS = "deb2-test-at-home-load-data-to-gcs"
KEYFILE_FOR_GCS_TO_BIGQUERY = "deb2-test-at-home-gcs-to-bigquery.json"
...
def _load_data_to_gcs(**context):
    ds = "2023-09-10"
    keyfile_gcs = f"{DAGS_FOLDER}/deb2-test-at-home-load-data-to-gcs.json"
    ...
    bucket_name = "deb2-end-to-end-project"
...
def _load_data_from_gcs_to_bigquery(**context):
    ds = "2023-09-10"
    keyfile_bigquery = f"{DAGS_FOLDER}/deb2-test-at-home-gcs-to-bigquery.json"
    ...
    table_id = f"{PROJECT_ID}.networkrail.{DATA}${ds_nodash}"
    bigquery_schema = [
